...
export const COPY = {
  zh: {
    ...
    lead: "Markdown2Card 是一款将 Markdown 内容转换为便于分享的图片卡片的 Obsidian 插件。一次付费即可获得永久授权，并解锁小红书一键发布能力，不包含订阅或自动续费。",
    once: "一次性付费 · 永久授权",
    permanent: "一次付费，永久使用并解锁小红书一键发布能力",
    devices: "不限设备数量，换电脑也能继续使用",
    recovery: "付款成功后立即显示激活码；成功页可在 2 小时内恢复",
    refund: "付款成功后 7 天内可申请全额退款",
    paymentMethods: "银行卡、支付宝或微信支付是否显示，以 Stripe 结账页和你的所在地区为准。如需使用小红书一键发布插件，请在付款时正确填写邮箱，插件安装包会发送到该邮箱。",
    checkout: "购买永久授权",
    navProduct: "产品说明",
    navPolicies: "购买政策",
    navContact: "联系我们",
    ...
    productUse: "付款后获得个人永久授权，可在多台个人设备上使用，无订阅费，并解锁小红书一键发布能力。",
    ...
    openHint: "推荐：一键返回插件完成激活，解锁小红书一键发布能力；如果浏览器没有响应，再复制激活码。",
  ...
  en: {
    ...
    lead: "Markdown2Card is an Obsidian plugin that turns Markdown content into shareable image cards. A single payment gives you a permanent licence and unlocks Xiaohongshu one-click publishing, with no subscription or automatic renewal.",
    once: "one-time payment · permanent licence",
    permanent: "Pay once for permanent use and Xiaohongshu one-click publishing",
    ...
    paymentMethods: "Cards, Alipay, and WeChat Pay appear only when eligible in Stripe Checkout. If you need the Xiaohongshu one-click publishing plugin, enter the correct email at checkout; the plugin installer will be sent there.",
    ...
    productUse: "Payment provides a permanent personal licence for use on multiple personal devices, with no subscription fee, and unlocks Xiaohongshu one-click publishing.",
    ...
    openHint: "Recommended: return to the plugin and activate in one click to unlock Xiaohongshu one-click publishing. Copy the code only if your browser cannot open Obsidian.",
